...
// flat method removes the nested array and flattens the array
console.log(nestedArray.flat()); // (8) [1, 2, 3, 4, 5, 6, 7, 8]

const deeperNested = [[[1, 2, 3]], [4, [5, 6]], 7, 8];

// flat method only goes one level deep to flatten the array
console.log(deeperNested.flat()); // (5) [Array(3), 4, Array(2), 7, 8]

// by default flat works on only 1 level deep
// we can pass paramter to flat method on number of levels
console.log(deeperNested.flat(2)); // (8) [1, 2, 3, 4, 5, 6, 7, 8]

// What if bank wants to check the overall movements in all the account
const accountMovements = accounts.map(acc => acc.movements);
console.log(accountMovements); // (4) [Array(8), Array(8), Array(8), Array(5)]

// flatten all movements in the bank
...
// Overall Balance in the Bank
const overallBalance = allMovements.reduce((total, m) => total + m, 0);
