...
// to identify if there are any positive movements in the array
const anyDeposits = movements.some(m => m > 0);
console.log(anyDeposits); // true

// to check if there is any deposit above 5000
const depositsAbove5k = movements.some(m => m > 5000);
console.log(depositsAbove5k); // false

// some and includes methods are similar
// includes check for equality where some checks for conditions

// Every Method
// Returns true when all the elements in the array satisfies the condition
console.log(movements.every(m => m > 0)); // false
console.log(account4.movements.every(m => m > 0)); // true

// passing function separately as callback
