...
const owners = ['Jonas', 'Kelvin', 'Adam', 'Zack'];
console.log(owners.sort()); // (4) ["Adam", "Jonas", "Kelvin", "Zack"]

// sort method mutatues the original array
console.log(owners); // (4) ["Adam", "Jonas", "Kelvin", "Zack"]

// sort method does sorting based on the string
console.log(movements); // (8) [200, 450, -400, 3000, -650, -130, 70, 1300]
console.log(movements.sort()); // (8) [-130, -400, -650, 1300, 200, 3000, 450, 70]

// sort on numbers
// returns < 0 then a will be before b
// returns > 0 then b will be before a
