...
// generate array programatically
const x = new Array(7);
console.log(x); // creates new array with 7 empty elements
// (7) [empty × 7]

// Only fill method can be called on empty array
x.fill(1); // will mutate the original array
console.log(x); // (7) [1, 1, 1, 1, 1, 1, 1]

// fill method also takes begin index
const y = new Array(7);
y.fill(1, 3);
console.log(y); // (7) [empty × 3, 1, 1, 1, 1]

// can also provide end parameter
// end index is not included
const z = new Array(7);
z.fill(1, 3, 5);
console.log(z); // (7) [empty × 3, 1, 1, empty × 2]

// fill method can also mutate arrays with values
const l = [0, 1, 2, 3, 4, 5, 6, 7];
l.fill(11, 2, 4);
console.log(l); // (8) [0, 1, 11, 11, 4, 5, 6, 7]

// -------------------------------------------------------------------------------------------------------------------------------------------

// from method
const from1 = Array.from({ length: 7 }, () => 1);
console.log(from1); // (7) [1, 1, 1, 1, 1, 1, 1]

const from2 = Array.from({ length: 7 }, (_, i) => i++);
console.log(from2); // (7)[(0, 1, 2, 3, 4, 5, 6)];

// get values from UI and convert it into array
labelBalance.addEventListener('click', function (event) {
	// adding callback function to from method
	...
	// this will also create array of elements
